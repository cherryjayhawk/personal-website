...
function Introduction() {
  ...
  return (
    <>
        ...
        {
          time2 ? (<TextGenerateEffect words="Software Developer based in Bandung, Indonesia." />) : (<span className="leading-snug tracking-wide  mt-1 invisible">Software Developer based in Bandung, Indonesia.</span>)
        }
    </>
  )
}
